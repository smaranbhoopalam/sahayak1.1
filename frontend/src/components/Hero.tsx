                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center bg-slate-50/90 p-5 rounded-2xl border border-slate-200/80">
                    ...
                    <div className="sm:col-span-5 flex flex-col items-center justify-center relative py-2">
                      <div className="relative w-36 h-56 flex items-center justify-center">
                        <svg viewBox="0 0 100 200" className="w-full h-full filter drop-shadow-[0_4px_12px_rgba(20,184,166,0.15)]">
                          <circle cx="50" cy="22" r="14" fill="#f1f5f9" stroke="#cbd5e1" strokeWidth="2" />
                          <rect x="46" y="36" width="8" height="8" fill="#cbd5e1" />
                          <path d="M 30,44 L 70,44 L 64,115 L 36,115 Z" fill="#f1f5f9" stroke="#cbd5e1" strokeWidth="2" />
                          <circle cx="54" cy="62" r="10" fill="rgba(20,184,166,0.15)" stroke="#0d9488" strokeWidth="2" className="animate-pulse" />
                          <rect x="42" y="78" width="16" height="12" rx="2" fill="rgba(16,185,129,0.2)" stroke="#059669" strokeWidth="1.5" />
                          <path d="M 28,45 L 14,100 M 72,45 L 86,100" stroke="#cbd5e1" strokeWidth="6" strokeLinecap="round" />
                          <path d="M 40,115 L 38,185 M 60,115 L 62,185" stroke="#cbd5e1" strokeWidth="8" strokeLinecap="round" />
                        </svg>
