...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden py-10 bg-[url('/medical_cross_bg.png')] bg-cover bg-center bg-no-repeat selection:bg-brand-500 selection:text-white">
